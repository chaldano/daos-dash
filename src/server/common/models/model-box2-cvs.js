...
const list1 = require('ServerData/edgeproblem-short.csv')
const list2 = require('ServerData/objectives-short.csv')
const list3 = require('ServerData/problems-short.csv')

let lists = [list1.default, list2.default, list3.default];
